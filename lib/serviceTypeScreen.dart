...
class serviceTypeScreen extends StatefulWidget {
  @override
  _serviceTypeScreenState createState() => new _serviceTypeScreenState();
}
...
class _serviceTypeScreenState extends State<serviceTypeScreen> {
  ...
  String strTitle="Add Service Type";
  ProgressDialog pr;
  bool isFirst=true;
...
//  }
  ...
  void saveData(var name) async  {
    ...
    DatabaseReference _companyRef = database.reference().child(DatabaseUtils.TBL_SERVICETYPE).child(strOrgId);
    ...
    NameData bd=new NameData(id, name, null, true, strOrgId, 0, createdTime, modifedTime);
  ...
  void checkNameExist(){
    ...
    try {
      ...
      DatabaseReference myRef = database.reference().child(DatabaseUtils.TBL_SERVICETYPE);
  ...
  void getEditDetails(String strId){
    ...
    try {
      ...
      DatabaseReference myRef = database.reference().child(DatabaseUtils.TBL_SERVICETYPE).child(strOrgId).child(strId);
