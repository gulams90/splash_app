...
class CancelledOrderHistory extends StatefulWidget {
  @override
  _CancelledOrderHistoryState createState() => new _CancelledOrderHistoryState();
}



class _CancelledOrderHistoryState extends State<CancelledOrderHistory> {
  ...
  static final String strTitle="Cancelled Services";
...
//    Navigator.of(context).pushNamed("/userTypeScreen");
  ...
  void getList(){
    ...
    try {
      ...
      Query qry=myRef.orderByChild("status").equalTo(StatusUtils.CANCELLED.toString());
