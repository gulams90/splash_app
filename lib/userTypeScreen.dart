...
class userTypeScreen extends StatefulWidget {
  @override
  _userTypeScreenState createState() => new _userTypeScreenState();
}
...
//  }
  ...
  void saveData(var name) async  {
    ...
    DatabaseReference _companyRef = database.reference().child(DatabaseUtils.TBL_USERTYPE).child(strOrgId);
  ...
  void checkNameExist(){
    ...
    try {
      ...
      DatabaseReference myRef = database.reference().child(DatabaseUtils.TBL_USERTYPE);
  ...
  void getEditDetails(String strId){
    ...
    try {
      ...
      DatabaseReference myRef = database.reference().child(DatabaseUtils.TBL_USERTYPE).child(strOrgId).child(strId);
      CommonUtils.showProgressBar( pr);
