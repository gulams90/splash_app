...
class branchList extends StatefulWidget {
  @override
  _branchListState createState() => new _branchListState();
}
...
class _branchListState extends State<branchList> {
  ...
  String strOrgId;
  List<CompanyData> alData=new List();
...
//  }
  ...
  void listItemClickEvent(CompanyData mdata){
...
//      });
  ...
  _onEntryChanged(Event event) {
    ...
    setState(() {
      ...
      alData[alData.indexOf(oldEntry)] = CompanyData.fromSnapshot(event.snapshot);
    });
  }

  @override
  void dispose() {
    subscriptionEntryAdded.cancel();
    subscriptionEntryChanged.cancel();
    super.dispose();
  }
...
//    initData();
    ...
    return new Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            Navigator.of(context).pushNamed("/branchScreen");
          },
